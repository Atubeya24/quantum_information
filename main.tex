...
\\
これに対する答えとして、「最大エンタングル状態とのFidelityが、teleportationの最大平均Fidelityを直接決定する」というstatementが知られている。この節では、この厳密な関係を与える。\\
...
\end{align*}
特に、最適化問題などでは、解空間を、ハミルトニアンの基底状態に写像することが多い。この場合、reflectionは以下の通りである。
\begin{align*}
